...
In this project, I made a simple marker-based AR application using A-Frame, AR.js, and GitHub Pages.

When the Hiro marker is scanned, 3 shapes appear:
- Box
- Cylinder
- Cone
